  ...
  const summaryPrompt = ChatPromptTemplate.fromMessages([
    [
      ...
      [
        ...
        "Keep verbatim the last two user questions so that it can be used to help give better answers to follow-up questions.",
...
export async function getAnswerText({ llm, question, sql, fields, rows }) {
  ...
  const answerPrompt = ChatPromptTemplate.fromMessages([
    [
      "system",
      [
        "You are a data analyst working in the retail industry.",
        "You are giving an answer to an executive or manager in charge of making decisions.",
        ...
        "Numbers must either be shown as whole numbers if integers, or with two decimal places if a decimal",
        "Put comma separators in numbers for thousands and millions",
        "",
